...
public class BusDialogWin78 extends JFrame implements ActionListener,WindowListener,KeyListener
{
    ...
    private BusDialog78 myDialog;
    public JButton send;
    private String myName = "Your";
    private String otherName = "Client";

    public BusDialogWin78(String header, BusDialog78 myDialog)
    {
        super(header);
