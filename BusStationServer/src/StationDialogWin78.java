...
public class StationDialogWin78 extends JFrame implements ActionListener,WindowListener,KeyListener
{
    ...
    private StationDialog78 myDialog;
    public JButton send;
    private String myName = "Your";
    private String otherName = "Client";

    public StationDialogWin78(String header, StationDialog78 myDialog)
    {
        super(header);
