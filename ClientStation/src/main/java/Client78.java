...
//	   new InputStreamReader(System.in));
            ...
            myOutput = new ClientWin78("Station", this);
            ...
            ///intlize
            String StationName=myOutput.sendStationName();
            MessageHandler messageHandler=new MessageHandler();
            messageHandler.setStationName(StationName);
            while (true)
            {
                ...
                {
                    myOutput.print("Connection closed by the Server.");
                    break;
                }
                ////////////////////////
                messageHandler.add_message(new Message().Deserilize(line));
                myOutput.print( messageHandler.createScreenMessage()); // shows it on the screen
                //////////////////////////////////////
