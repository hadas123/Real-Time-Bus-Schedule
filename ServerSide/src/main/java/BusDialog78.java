...
class BusDialog78 extends Thread // parallel dialogs on the same socket
{
    ...
    int id;
    public BusDialog78(Socket clientSocket, BusServer78 myServer, MessageManager messagemanager, int id)
    ...
    public void run()
    {
        ...
        try
        {
            ...
            {	
                ...
                if (line.equals("end"))
                { 
                	messagemanager.sendFinishDriving(bussLine,id);
                	break;
                	
                }
                
                messagemanager.announceApproach(bussLine, line,id);
